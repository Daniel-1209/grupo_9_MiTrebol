...
window.addEventListener('load', function () {
    let formEditTag = document.querySelector('#formEdit');
    ...
    let btnSubmitEdit = document.querySelector('#submitEdit');
   ...
   // div de errores
    ...
    btnSubmitEdit.addEventListener('click', function (evento) {
