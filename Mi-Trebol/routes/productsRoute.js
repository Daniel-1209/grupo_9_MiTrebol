...
const validateUpdatete = require("../Middleaweares/validateUpdateProduct");
...
router.post(
  "/cart/:id",
  noRegisterMiddleaware,
  productsController.newCarProduct
);
// Eliminar un nuevo producto al carrito
router.delete(
  "/cart/delete/:id",
  noRegisterMiddleaware,
  productsController.deleteCarProduct
);
